  ...
  useLayoutEffect(() => {
    ...
    fsEnter?.addEventListener("click", function (e) {
      ...
      if (!fullscreen) {
        ...
        if (fsEnter && fsEnter.innerHTML) fsEnter.innerHTML = "Exit Fullscreen";
      } else {
        fullscreen = false;
        document.exitFullscreen();
        if (fsEnter && fsEnter.innerHTML) fsEnter.innerHTML = "Go Fullscreen";
      }
    });
  });
  return (
    <>
      ...
      <button className="btn" id="fullscr">
        Go Fullscreen
      </button>
    </>
  );
